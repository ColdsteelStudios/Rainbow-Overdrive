...
public class MatchManagerLocal : MonoBehaviour 
{
    ...
    public void PlayerDead()
    {
        ...
        if((m_playersAlive<=1)&& m_gameStarted)
        {
            ...
            m_gameStarted = false;
            //Announce the victor
            m_messageDisplay.text = "Announce victor";
            Cleanup();
    ...
    {
        //Remove screen message from end of match countdown
        m_messageDisplay.text = "";
        //Find all players
        GameObject[] l_players = GameObject.FindGameObjectsWithTag("Player");
